...
bool selinos_execve_reply_argv0_string_byte_m0_start(vka_t *vka, vspace_t *vspace)
{
    ...
    _Static_assert(sizeof(seL4_UserContext) / sizeof(seL4_Word) ==
                   ...
                   "Phase 92 requires complete pinned x86_64 context");
    ...
    /* Phase 92 witness: mov rax,[rsp+8]; movzx eax,byte ptr [rax]; ud2. */
    ...
    ((volatile uint8_t *)root_interpreter_mapping)[7u] = 0x00u;
    ((volatile uint8_t *)root_interpreter_mapping)[8u] = 0x0fu;
    ((volatile uint8_t *)root_interpreter_mapping)[9u] = 0x0bu;
