...
def main():
    ...
    phase66 = body.index('#if CONFIG_SELINOS_STATIC_IMAGE_TERMINAL_LIFECYCLE_PROBE')
    phase66_end = body.index('\n#endif', phase66) + len('\n#endif')
    lifecycle = body[phase66:phase66_end]
    ...
    observation = lifecycle.index('selinos_static_image_terminal_lifecycle_m0_record') + phase66
