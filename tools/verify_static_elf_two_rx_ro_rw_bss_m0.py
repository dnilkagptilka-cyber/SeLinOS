#!/usr/bin/env python3
"""Independently verify the bounded Phase 82 two-RX ELF64 M0 proof."""
...
MANIFEST = ROOT / "tests/artifacts/selinos_static_elf_two_rx_ro_rw_bss_m0.verification.json"
...
def main() -> int:
    ...
    require(evidence.get("milestone") ==
            "SeLinOS static ELF64 two-RX plus RO plus RW/BSS load M0",
            "wrong milestone")
    require(evidence.get("status") == "verified", "milestone is not verified")

    profile = evidence["profile"]
    require(profile["cmake_option"] == "SeLinStaticElfTwoRxRoRwBssM0=ON",
    ...
    require("#define CONFIG_SELINOS_STATIC_ELF_TWO_RX_RO_RW_BSS_M0_PROBE" in config and
            "/* disabled: CONFIG_SELINOS_STATIC_ELF_TWO_RX_RO_RW_BSS_M0_PROBE */" not in config,
            "Phase 82 selector not enabled in isolated generated config")

    sources = {label: text(record, label)
               for label, record in evidence["implementation"].items()}
    cmake = sources["build_gate"]
    for required in (
        "SeLinStaticElfTwoRxRoRwBssM0",
        "SELINOS_STATIC_ELF_TWO_RX_RO_RW_BSS_M0_PROBE",
        "DEFAULT\n    OFF",
        "selinos-static-elf-two-rx-ro-rw-bss-m0-fixture",
        "static_elf_two_rx_ro_rw_bss_m0_root.c",
    ):
        require(required in cmake, f"missing Phase 82 CMake contract: {required}")
    ...
    for required in (
        ...
        "[232] = 1u",
        "[236] = 5u",
        "SELINOS_STATIC_ELF_TWO_RX_RO_RW_BSS_M0_ENTRY_PAYLOAD_BYTES",
        "SELINOS_STATIC_ELF_TWO_RX_RO_RW_BSS_M0_SECOND_RX_PAYLOAD_BYTES",
        "SELINOS_STATIC_ELF_TWO_RX_RO_RW_BSS_M0_RO_INITIALIZED_BYTES",
        "SELINOS_STATIC_ELF_TWO_RX_RO_RW_BSS_M0_DATA_MEMORY_BYTES",
    ...
    for required in (
        ...
        "SELINOS_STATIC_ELF_TWO_RX_RO_RW_BSS_M0_FIXED_ENTRY_VADDR",
        "SELINOS_STATIC_ELF_TWO_RX_RO_RW_BSS_M0_FIXED_SECOND_RX_VADDR",
        "SELINOS_STATIC_ELF_TWO_RX_RO_RW_BSS_M0_FIXED_RO_VADDR",
        "SELINOS_STATIC_ELF_TWO_RX_RO_RW_BSS_M0_FIXED_DATA_VADDR",
        "SELINOS_STATIC_ELF_TWO_RX_RO_RW_BSS_M0_BSS_OFFSET",
    ...
    require(transaction.index(
        "SELINOS_STATIC_ELF_TWO_RX_RO_RW_BSS_M0_FIXED_SECOND_RX_VADDR", fault_check) >
            fault_check,
            "terminal fault is not bound to the second RX page")

    protocol = sources["protocol"]
    for required in (
        "SELINOS_STATIC_ELF_TWO_RX_RO_RW_BSS_M0_FAULT_BADGE 0x82u",
        "SELINOS_STATIC_ELF_TWO_RX_RO_RW_BSS_M0_FIXED_ENTRY_VADDR 0x60000000u",
        "SELINOS_STATIC_ELF_TWO_RX_RO_RW_BSS_M0_FIXED_DATA_VADDR 0x60001000u",
        "SELINOS_STATIC_ELF_TWO_RX_RO_RW_BSS_M0_FIXED_RO_VADDR 0x60002000u",
        "SELINOS_STATIC_ELF_TWO_RX_RO_RW_BSS_M0_FIXED_SECOND_RX_VADDR 0x60003000u",
        "SELINOS_STATIC_ELF_TWO_RX_RO_RW_BSS_M0_ENTRY_PAYLOAD_BYTES 5u",
        "SELINOS_STATIC_ELF_TWO_RX_RO_RW_BSS_M0_SECOND_RX_PAYLOAD_BYTES 72u",
        "SELINOS_STATIC_ELF_TWO_RX_RO_RW_BSS_M0_RO_INITIALIZED_BYTES 4u",
        "SELINOS_STATIC_ELF_TWO_RX_RO_RW_BSS_M0_DATA_INITIALIZED_BYTES 4u",
        "SELINOS_STATIC_ELF_TWO_RX_RO_RW_BSS_M0_DATA_MEMORY_BYTES 64u",
        "SELINOS_STATIC_ELF_TWO_RX_RO_RW_BSS_M0_BSS_BYTES 60u",
        "SELINOS_STATIC_ELF_TWO_RX_RO_RW_BSS_M0_DATA_INITIAL_VALUE 0x534c3832u",
        "SELINOS_STATIC_ELF_TWO_RX_RO_RW_BSS_M0_RO_INITIAL_VALUE 0x524f3832u",
        "SELINOS_STATIC_ELF_TWO_RX_RO_RW_BSS_M0_SUCCESS_UD2_OFFSET 70u",
    ):
    ...
    print("SeLinOS static ELF64 two-RX plus RO plus RW/BSS load M0 evidence verified.")
    return 0
